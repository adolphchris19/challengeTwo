...
public class PhysicsActivity extends AppCompatActivity {
    ...
    private void questionOne(){
        ...
        if (buttonTwo.isChecked()){
            ...
            TextView ans1 = findViewById(R.id.answerPhysics1);
            ans1.setText(getResources().getString(R.string.ansPhysics1));
    ...
    private void questionTwo(){
        ...
        if (buttonTwo.isChecked()){
            buttonTwo.setBackground(getResources().getDrawable(R.drawable.radio_buttons));
            TextView ans2 = findViewById(R.id.answerPhysics2);
            ans2.setText(getResources().getString(R.string.ansPhysics2));
    ...
    private void questionThree(){
        ...
        if (buttonTwo.isChecked()){
            buttonTwo.setBackground(getResources().getDrawable(R.drawable.radio_buttons));
            TextView ans3 = findViewById(R.id.answerPhysics3);
            ans3.setText(getResources().getString(R.string.ansPhysics3));
    ...
    private void questionFour(){
        ...
        if (buttonTwo.isChecked()){
            buttonTwo.setBackground(getResources().getDrawable(R.drawable.radio_buttons));
            TextView ans4 = findViewById(R.id.answerPhysics4);
            ans4.setText(getResources().getString(R.string.ansPhysics4));
    ...
    private void questionFive(){
        ...
        if (wrongOne) {
            buttonThree.setBackground(getResources().getDrawable(R.drawable.radio_buttons));
            TextView ans5 = findViewById(R.id.answerPhysics5);
            ans5.setText(getResources().getString(R.string.ansPhysics5));
    ...
    private void questionSix(){
        ...
        if (myAnswer.trim().equalsIgnoreCase(evaporation)){
            ...
            TextView ans6 = findViewById(R.id.answerPhysics6);
            ans6.setText(getResources().getString(R.string.ansPhysics6));
    ...
    private void questionSeven(){
        ...
        if (wrongOne) {
            buttonThree.setBackground(getResources().getDrawable(R.drawable.radio_buttons));
            TextView ans7 = findViewById(R.id.answerPhysics7);
            ans7.setText(getResources().getString(R.string.ansPhysics7));
    ...
    private void questionEight(){
        ...
        if (myAnswerTwo.trim().equalsIgnoreCase(element)){
            ...
            TextView ans8 = findViewById(R.id.answerPhysics8);
            ans8.setText(getResources().getString(R.string.ansPhysics8));
    ...
    private void questionNine(){
        ...
        if (wrongOne) {
            buttonThree.setBackground(getResources().getDrawable(R.drawable.radio_buttons));
            TextView ans9 = findViewById(R.id.answerPhysics9);
            ans9.setText(getResources().getString(R.string.ansPhysics9));
    ...
    private void questionTen(){
        ...
        if (myAnswerThree.trim().equalsIgnoreCase(acid)){
            ...
            TextView ans10 = findViewById(R.id.answerPhysics10);
            ans10.setText(getResources().getString(R.string.ansPhysics10));
